...
---
# <a name="update-dns-records-at-dreamhost"></a>עדכון רשומות DNS ב- Dreamhost

השתמש בקישורים שלהלן כדי לעזור לעדכן את רשומות ה- DNS שלך.

- [יצירת רשומות DNS ב- Dreamhost](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-dreamhost?view=o365-worldwide)
