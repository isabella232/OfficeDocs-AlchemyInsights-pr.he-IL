...
---
# <a name="delete-a-site-from-the-new-sharepoint-admin-center"></a>מחיקת אתר ממרכז admin חדשה של SharePoint
...
- כדי להסיר לצמיתות את אתר, ראה [אתר למחוק לצמיתות](https://docs.microsoft.com/sharepoint/delete-site-collection#permanently-delete-a-site). שלב זה יידרש אם אתה מתכנן להשתמש מחדש של כתובת ה-URL. 
- כדי להסיר אתר משנה, ראה [מחיקת אתר או אתר משנה quicksteps](https://support.office.com/article/Delete-a-SharePoint-site-or-subsite-bc37b743-0cef-475e-9a8c-8fc4d40179fb#__bkmkshortcut)
