...
---
# <a name="organizing-your-outlookcom-mailbox"></a>ארגון תיבת הדואר שלך ב-Outlook.com

רשימת אנשי קשר היא אוסף של כתובות דואר אלקטרוני, והיא שימושית לשליחת דואר אלקטרוני לקבוצת אנשים. כדי ליצור רשימת אנשי קשר:
...
1. בחלק העליון של הדף, בחר את החץ <img src='data:image/png;base64,' /> לצד **איש קשר חדש** ולאחר מכן בחר **רשימת אנשי קשר חדשה**.
1. הזן שם עבור הרשימה ולאחר מכן הוסף שמות או כתובות דואר אלקטרוני.
1. בחר **צור**.

קבל מידע נוסף על [יצירה, הצגה ועריכה של אנשי קשר ורשימות אנשי קשר ב-Outlook.com](https://support.office.com/article/5b909158-036e-4820-92f7-2a27f57b9f01?wt.mc_id=Office_Outlook_com_Alchemy).