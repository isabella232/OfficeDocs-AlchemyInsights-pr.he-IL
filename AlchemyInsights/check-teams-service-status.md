...
---
# <a name="check-teams-service-status"></a>בדוק את מצב שירות הצוותים

כדי לבדוק את המצב הנוכחי של שירות הצוותים של Microsoft, עבור אל לוח הבקרה של שירות מרכז הניהול של Microsoft 365.
