...
---
# <a name="import-contacts"></a>יבא אנשי קשר

לפני ייבוא אנשי קשר ל-Outlook.com, יהיה עליך לייצא אותם מספק הדואר האלקטרוני האחר שלך כקובץ csv. לאחר מכן, בצע את ההוראות שלהלן.
...
.
2. בראש הדף, בחר באפשרות **נהל** \> **אנשי קשר של ייבוא**.
3. בחרו ' **עיון**', נווטו לתיקייה שבה שמרת את אנשי הקשר המיוצאים ובחרו ' **פתח**'.

כדי ללמוד עוד, ראה [ייבוא אנשי קשר ל-Outlook.com](https://support.office.com/article/285a3b55-8d93-4ac8-93df-43fffd13b2f1?wt.mc_id=Office_Outlook_com_Alchemy).