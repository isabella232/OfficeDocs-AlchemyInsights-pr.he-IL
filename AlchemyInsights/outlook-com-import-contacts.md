...
ms.locfileid: "53962204"
---
# <a name="import-contacts"></a>ייבוא אנשי קשר

לפני ייבוא אנשי קשר אל Outlook.com, יהיה עליך לייצא אותם מספק הדואר האלקטרוני האחר שלך כקובץ .csv אחר. לאחר מכן, בצע את ההוראות שלהלן.
...
.
2. בחלק העליון של הדף, בחר **נהל** \> **אנשי קשר של ייבוא**.
3. בחר **עיון**, נווט אל התיקיה שבה שמרת את אנשי הקשר המיוצאים ובחר **פתח**.

לקבלת מידע נוסף, ראה [ייבוא אנשי קשר אל Outlook.com](https://support.office.com/article/285a3b55-8d93-4ac8-93df-43fffd13b2f1?wt.mc_id=Office_Outlook_com_Alchemy).
