...
2. לחץ על **[רכישת שירותים](https://admin.microsoft.com/AdminPortal/Home?adminportal=1&msCV=%2BbOQtMNsz0ei8f5z.0.36#/catalog)** כדי להציג את המנויים הזמינים לרכישה עבור הארגון שלך.

3. אתר את תוכניות Project על-ידי חיפוש ב- "Project".

4. בחר מבין תוכניות Project השונות שזמינות.
