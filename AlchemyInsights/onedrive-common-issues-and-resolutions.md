...
נראה כאילו אתה שואל אודות OneDrive. אנו יכולים לסייע לתת לך תשובה טובה יותר אם בקצרה נסח מחדש את שאלתך עם משפטים אחד או שניים המתארים את הבעיה - כולל שגיאות, התכונות שבהן אתה משתמש, וכו '...  

בינתיים, להלן כמה נושאים לעתים קרובות המבוקש:
...
- **אחסון OneDrive**: ראה כיצד [לשנות מקום אחסון OneDrive משתמשים ספציפיים](https://docs.microsoft.com/onedrive/change-user-storage) או [לנהל את OneDrive עבור אחסון לעסק](https://support.office.com/article/Manage-your-OneDrive-for-Business-storage-31519161-059C-4764-B6F8-F5CD29F7FE68).
