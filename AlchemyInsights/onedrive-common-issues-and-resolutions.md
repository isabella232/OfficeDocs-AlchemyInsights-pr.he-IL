...
- **ההתקנה Onedrive sync**: [סנכרן את onedrive שלך עבור קבצים עסקיים](https://go.microsoft.com/fwlink/?linkid=533375) או [סינכרון קבצי SharePoint](https://go.microsoft.com/fwlink/?linkid=871666) עם לקוח סינכרון onedrive עבור Windows.  משתמש ב-Mac? באפשרותך [לסנכרן גם קבצים עם OneDrive](https://support.office.com/article/Sync-files-with-the-OneDrive-sync-client-on-Mac-OS-X-d11b9f29-00bb-4172-be39-997da46f913f) .
...
- **יומני ביקורת**: ראה כיצד [באפשרותך להשתמש בחיפוש יומן ביקורת](https://docs.microsoft.com/microsoft-365/compliance/search-the-audit-log-in-security-and-compliance#search-the-audit-log) כדי לבדוק את הפעילות של הקבצים, התיקיות, המשתמשים או ההרשאות. 
