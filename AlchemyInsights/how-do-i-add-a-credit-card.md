...
2. בחר את המנוי שברצונך לשלם עבורו באמצעות כרטיס האשראי או חשבון הבנק החדש ולאחר מכן בחר **עדכן פרטי תשלום**.
    
3. בחר את החץ הנפתח תחת **הוספה או בחירה של שיטת תשלום** ולאחר מכן בחר **כרטיס אשראי חדש** או **חשבון בנק חדש**.
    
4. הזן את המידע עבור כרטיס האשראי או חשבון הבנק החדש ולאחר מכן בחר 'שלח'.
