...
בנוסף, החל בגירסה 1906 בערוץ החודשי, הצוותים *יתווספו להתקנות הקיימות* של Office 365 proplus (ו-Office 365 Business) בהתקנים המפעילים את Windows כאשר תעדכן את ההתקנה הקיימת שלך בגירסה העדכנית ביותר. לקבלת מידע נוסף, ראה [מה לגבי התקנות קיימות של Office?](https://docs.microsoft.com/deployoffice/teams-install#what-about-existing-installations-of-office-365-proplus)
