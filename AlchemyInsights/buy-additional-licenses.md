...
---
# <a name="buy-additional-licenses"></a>קנה רשיונות נוספים
...
2. חפש את המנוי שאליו ברצונך להוסיף רשיונות ולאחר מכן בחר **בהוספה/הסרה של רשיונות**.
    ...
    [מה קורה אם איני רואה את הקישור ' הוספה/הסרה '?](https://docs.microsoft.com/office365/admin/subscriptions-and-billing/buy-licenses#what-if-i-dont-see-the-addremove-licenses-link)
...
- [הקצאת רשיונות למשתמשים ב-Microsoft 365 עבור Business](https://docs.microsoft.com/office365/admin/subscriptions-and-billing/assign-licenses-to-users)