...
- [SharePoint במצב מקוון ומהירות ההעברה OneDrive](https://docs.microsoft.com/en-us/sharepointmigration/sharepoint-online-and-onedrive-migration-speed)

 - [לטפל SharePoint Online ויסות באמצעות מעריכי ויתור](https://docs.microsoft.com/en-us/sharepoint/dev/solution-guidance/handle-sharepoint-online-throttling-by-using-exponential-back-off)

- [קיבולת תכנון וטען בדיקה מקוונת של SharePoint](https://support.office.com/en-us/article/Capacity-planning-and-load-testing-SharePoint-Online-c932bd9b-fb9a-47ab-a330-6979d03688c0)
