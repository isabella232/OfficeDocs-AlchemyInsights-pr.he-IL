...
תוכל גם לשמור תוכן זה על-ידי הוספת תיבת הדואר מדיניות שמירה. פעולה זו תמקם תוכן בתיבת הדואר הראשית והן ארכיון בחסימה. לקבלת מידע נוסף אודות יצירת מדיניות שמירה כדי לשמור השלבים לרמות [כאן](https://docs.microsoft.com/en-us/Office365/securitycompliance/retention-policies)emailsee.
