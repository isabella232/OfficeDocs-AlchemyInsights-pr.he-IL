...
ms.locfileid: "36749729"
---
# <a name="sharing-and-permission-methods-to-provide-or-restrict-user-access-to-sharepoint-site"></a>שיטות שיתוף והרשאה לספק או להגביל את גישת המשתמש לאתר SharePoint

לאחר שיצרת אתר SharePoint, ייתכן שתרצה לספק או להגביל את גישת המשתמש לאתר או לתוכנו. ניתן לבצע זאת באמצעות שיטות שיתוף והרשאות שונות המצוינות להלן.
...
- [שינוי סוג הקישור המוגדר כברירת מחדל כאשר משתמשים מקבלים קישורים לשיתוף](https://docs.microsoft.com/sharepoint/change-default-sharing-link)
