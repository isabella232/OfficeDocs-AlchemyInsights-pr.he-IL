...
- אם המסמך מכיל שינויים מסומנים, השתמש בהצעות ב- [Word מאט או מפסיק להגיב אם יש שינויים או הערות מסומנים מוגזמת](https://docs.microsoft.com/office/troubleshoot/word/word-stops-responding) כדי לפתור את הבעיה.
