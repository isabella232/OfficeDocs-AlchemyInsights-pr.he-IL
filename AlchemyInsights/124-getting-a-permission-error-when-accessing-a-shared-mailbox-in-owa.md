...
אם תקבל את שגיאה **משהו השתבש. אין לך הרשאה לפתוח תיבת דואר זו.** כאשר תנסה לפתוח תיבת דואר משותפת ב- Outlook באינטרנט, החשבון שלך ייתכן שאין לך הרשאה לגשת תיבת הדואר המשותפת. מנהל המערכת בארגון שלך יכול להקצות הרשאות החשבון שלך תיבת הדואר המשותפת על-ידי ביצוע ההוראות המופיעות בנושא [יצירת תיבת דואר משותפת](https://support.office.com/article/871a246d-3acd-4bba-948e-5de8be0544c9).
