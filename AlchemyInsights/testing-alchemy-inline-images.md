...
---
# <a name="access-the-domains-page"></a>גישה לדף התחומים

כדי לגשת לדף התחומים, פשוט לחץ על סמל זה להלן:
...
לאחר מכן, באפשרותך להוסיף, לשנות או להסיר את התחום שלך.
לקבלת מידע נוסף, עיין [בתחומים שאלות נפוצות.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)
