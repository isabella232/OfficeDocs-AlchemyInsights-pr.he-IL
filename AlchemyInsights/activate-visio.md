...
לפני שהמשתמש יוכל להתקין ולהפעיל את יישום שולחן העבודה של Visio בשולחן העבודה הכלול בתוכנית המקוונת שלהם ב-Visio Online, על המשתמש להיות מוקצה [רשיון Visio](https://docs.microsoft.com/microsoft-365/admin/add-users/add-users).
