...
---
# <a name="open-a-sharepoint-library-in-file-explorer"></a>פתח ספריית SharePoint ב- Explorer קובץ

1. נווט אל הספריה ב- Internet Explorer 10 או 11 של Internet Explorer. 
    
2. לחץ על הסמל ' תצוגה ' בפינה הימנית העליונה ולאחר מכן לחץ על **תצוגת סייר הקבצים**.
