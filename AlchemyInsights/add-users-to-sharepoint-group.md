...
---
# <a name="add-users-to-a-sharepoint-group"></a>הוספת משתמשים לקבוצת SharePoint
...
- [הוספה או הסרה של חברים מ-Microsoft 365 קבוצות באמצעות מרכז הניהול](https://docs.microsoft.com/microsoft-365/admin/create-groups/add-or-remove-members-from-groups)