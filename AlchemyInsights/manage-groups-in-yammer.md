...
- **הרשאת יצירה קבוצתית.** . יאממר לא שולט במי שיכול ליצור קבוצה עם זאת, ניתן לנהל יצירה קבוצתית עבור קבוצות מקושרות של Microsoft 365. ראה [ניהול מי יכול ליצור קבוצות של Microsoft 365](https://docs.microsoft.com/microsoft-365/admin/create-groups/manage-creation-of-groups) לקבלת מידע נוסף.
...
- **שחזור קבוצות שנמחקו.** ניתן לשחזר קבוצות מיממר [באמצעות שחזור של קבוצת Microsoft 365 שאינה מחוברת לקבוצות שאינן מחוברות לאחר המחיקה](https://docs.microsoft.com/microsoft-365/admin/create-groups/restore-deleted-group) .
