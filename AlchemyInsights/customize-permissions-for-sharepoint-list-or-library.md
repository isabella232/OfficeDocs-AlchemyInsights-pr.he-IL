...
---
# <a name="how-to-customize-permissions-for-a-sharepoint-list-or-library"></a>כיצד להתאים אישית הרשאות עבור רשימה או ספריה של SharePoint

כמנהל או כבעלים של ספריה, רשימה או סקר, באפשרותך לשנות הרשאות כדי לאפשר לקבוצה אחת של אנשים לגשת לנתונים הדרושים להם תוך הגבלת אנשים.
