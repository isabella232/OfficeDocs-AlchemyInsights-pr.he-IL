...
אם אתה מקבל את השגיאה **, משהו השתבש. אין לך הרשאה לפתוח תיבת דואר זו.** כאשר אתה מנסה לפתוח תיבת דואר משותפת ב-Outlook באינטרנט, ייתכן שהחשבון שלך אינו כולל הרשאה לגשת לתיבת הדואר המשותפת. מנהל הארגון שלך יכול להקצות את הרשאות החשבון שלך לתיבת הדואר המשותפת על-ידי ביצוע ההוראות בנושא [יצירת תיבת דואר משותפת](https://docs.microsoft.com/microsoft-365/admin/email/create-a-shared-mailbox).
