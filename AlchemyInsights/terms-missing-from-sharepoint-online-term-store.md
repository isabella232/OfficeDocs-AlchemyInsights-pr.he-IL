...
---
# <a name="terms-missing-from-sharepoint-online-term-store"></a>תנאי חסר מתוך מאגר המונחים המקוונת של SharePoint

הופעה תנאי SharePoint אינם מופיעים כאשר אתה מצפה לראות חנות מקוונת של מונח או אינם לסירוגין.
