...
---
# <a name="web-only-limited-access"></a>גישה מוגבלת Web-Only

Web-Only גישה מוגבלת היא גירסה של רמת ההרשאה ' גישה מוגבלת ' המאפשרת למשתמשים גישה לאובייקט האינטרנט בלבד.
